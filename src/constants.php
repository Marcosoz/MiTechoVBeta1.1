...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "project290825TrabajosCreatedAT"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{1E20465B-36C6-4BDF-85AC-982EDCBA0E9A}"); // Project ID
