...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/project250825AsignacionAutomaticaCoopASocios.css", // Project stylesheet file name
    ...
    // Export Log
    "EXPORT_PATH" => "export-a81ac1ca-32d0-4e22-8311-13fe01d4e508", // Export folder
