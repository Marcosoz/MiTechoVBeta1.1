...
return [
    ...
    // Connection info
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "password" => "", "dbname" => "mitecho"]
    ],
    ...
    // JWT
    "JWT" => [
        "SECRET_KEY" => "rAgS+B1BHhYvB+V4oGHMhiqBBv93vGK5WBwLoy9gods=", // JWT secret key
