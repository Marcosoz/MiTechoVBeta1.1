 ...
 * Page class
 */
class CuposDelete extends Cupos
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "CuposDelete";
    ...
    public function run(): void
    {
        ...
        if ($filter == "") {
            $this->terminate("CuposList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("CuposList"); // Return to list
                return;
            }
        }
