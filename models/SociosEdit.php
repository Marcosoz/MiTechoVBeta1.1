...
class SociosEdit extends Socios
{
    ...
    protected function loadFormValues(): void
    {
        ...
        // Check field name 'nivel_usuario' before field var 'x_nivel_usuario'
        $val = $this->getFormValue("nivel_usuario", null) ?? $this->getFormValue("x_nivel_usuario", null);
        if (!$this->nivel_usuario->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->nivel_usuario->Visible = false; // Disable update for API request
            } else {
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // nivel_usuario
            $this->nivel_usuario->setupEditAttributes();
            if (!$this->security->canAdmin()) { // System admin
                $this->nivel_usuario->EditValue = $this->language->phrase("PasswordMask");
            } else {
