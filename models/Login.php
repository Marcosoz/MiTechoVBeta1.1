...
class Login extends Socios
{
    ...
    public function run(): void
    {
        ...
        $this->Username = new DbField("socios", "username", "username", "username", "", 202, 255);
        ...
        $this->Password = new DbField("socios", "password", "password", "password", "", 202, 255);
