...
/**
 * Table class for cupos
 */
class Cupos extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->UpdateTable = "cupos"; // Update table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->cupo->Raw = true;
        $this->cupo->Nullable = false; // NOT NULL field
        $this->cupo->Required = true; // Required field
        $this->cupo->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        $this->cupo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "cupos";
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("CuposList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "CuposView" => $this->language->phrase("View"),
            "CuposEdit" => $this->language->phrase("Edit"),
            "CuposAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName(string $action): string
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CuposView",
            Config("API_ADD_ACTION") => "CuposAdd",
            Config("API_EDIT_ACTION") => "CuposEdit",
            Config("API_DELETE_ACTION") => "CuposDelete",
            Config("API_LIST_ACTION") => "CuposList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CuposView", $parm);
        } else {
            $url = $this->keyUrl("CuposView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CuposEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CuposList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CuposList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $parm = ""): string
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("CuposDelete", $parm);
        }
    }
    ...
    public function renderLookupForView(string $name, mixed $value): mixed
    {
        ...
        if ($name == "cupo") {
            $clone = $this->cupo->getClone()->setViewValue($value);
