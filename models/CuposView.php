...
class CuposView extends Cupos
{
    ...
    // Page object name
    public string $PageObjName = "CuposView";
    ...
    // CSS class/style
    public string $CurrentPageName = "CuposView";
    ...
    public function run(): void
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CuposList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CuposList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
