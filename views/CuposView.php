...
?>
<main class="view">
<form name="fcuposview" id="fcuposview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script<?= Nonce() ?>>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cupos_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->cupo->Visible) { // cupo ?>
    <tr id="r_cupo"<?= $Page->cupo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cupos_cupo"><?= $Page->cupo->caption() ?></span></td>
