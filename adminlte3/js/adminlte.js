/*!
 * AdminLTE v3.2.1 (https://adminlte.io)
...
(function (global, factory) {
  ...
  var EVENT_LOAD_SUCCEEDED = "load.succeeded" + EVENT_KEY$7; //***
  var EVENT_LOAD_FAILED = "load.failed" + EVENT_KEY$7; //***
    ...
    _proto.load = function load() {
      ...
      $__default["default"].ajax(this._settings.source, $__default["default"].extend(true, {
        ...
        success: function success(response) {
          ...
          $__default["default"](_this._element).trigger($__default["default"].Event(EVENT_LOAD_SUCCEEDED), [response]); //***
        },
      ...
      .fail(function (jqXHR, textStatus, errorThrown) {
        ...
        $__default["default"](_this._element).trigger($__default["default"].Event(EVENT_LOAD_FAILED), [jqXHR, textStatus, errorThrown]); //***
      });
